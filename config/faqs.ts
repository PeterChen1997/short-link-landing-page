export const FAQS_EN = [
  ...
  // },
  {
    title: "How is Link Fun different from other link shorteners?",
    content:
      "Link Fun is specifically optimized for the Chinese market, providing faster access speeds and stronger localization support. We integrate advanced analytics and marketing tools to make link management smarter.",
  },
  {
    title: "How do I get started with Link Fun?",
    content:
      "Simply sign up for an account to use our basic features for free. Upgrade to Pro for access to advanced features.",
  },
  // {
...
export const FAQS_ZH = [
  ...
  // },
  {
    title: "Link Fun和其他短链接服务有什么区别？",
    content:
      "Link Fun特别针对中国市场优化，提供更快的访问速度、更强的本地化支持，同时整合了数据分析和营销工具，让链接管理更智能。",
  },
  {
    title: "如何开始使用Link Fun？",
    content:
      "只需注册账号，即可免费使用基础功能。升级到Pro版本则可享受更多高级特性。",
  },
  // {
  //   title: "使用这个模板我需要哪些技能？",
  //   content:
